...
namespace Plugin.Xablu.Walkthrough.Extensions
{
    ...
    {
        public static void SetControl<T>(this UIKit.UITextView textview, T control) where T : TextControl
        {
        ...
        public static void SetControl<T>(this UIKit.UILabel textview, T control) where T : TextControl
        {
            textview.TextColor = control.TextColor.ToNative();
            textview.Font = UIKit.UIFont.FromName(textview.Font.Name, control.TextSize);
            textview.Text = control.Text;
        ...
        public static async Task SetControl<T>(this UIKit.UIImageView imageView, T control) where T : ImageControl
        {
            var splatImage = await BitmapLoader.Current.LoadFromResource(control.Image, null, null);
            imageView.Image = splatImage.ToNative();
        }

        public static void SetControl<T>(this UIKit.UIButton button, T control) where T : ButtonControl
        {
