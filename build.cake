...
var isRepository = StringComparer.OrdinalIgnoreCase.Equals("Xablu/Xablu.Walkthrough", AppVeyor.Environment.Repository.Name);
    ...
    .Does(() => 
{
    var nugetSettings = new NuGetPackSettings {
        ...
        LicenseUrl = new Uri("https://github.com/Xablu/Xablu.Walkthrough/blob/master/LICENSE"),
